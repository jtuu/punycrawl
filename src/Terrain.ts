...
export class Terrain {
    ...
    public static readonly Wall        = new Terrain("Wall",      rgb( 33,  33,  33), null, true, 1);
    public static readonly Floor       = new Terrain("Floor",     rgb(100, 100, 100), null, false, 0);
    public static readonly Upstairs    = new Terrain("Staircase", rgb(100, 100, 100), "upstairs", false, 0, ClimbDirection.Up);
    public static readonly Downstairs  = new Terrain("Staircase", rgb(100, 100, 100), "downstairs", false, 0, ClimbDirection.Down);
